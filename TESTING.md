...
- https://validator.w3.org/nu/?doc=https://fattig-riddare-90.github.io/journeyman/index.html
...
| journal | [edit_entry.html](https://github.com/fattig-riddare-90/journeyman/blob/main/journal/templates/journal/edit_entry.html) | Link (if applicable) | ![screenshot](documentation/validation/html-journal-edit_entry.png) | Notes (if applicable) |

| journal | [my_entries.html](https://github.com/fattig-riddare-90/journeyman/blob/main/journal/templates/journal/my_entries.html) | Link (if applicable) | ![screenshot](documentation/validation/html-journal-my_entries.png) | Notes (if applicable) |

| journal | [public_entries.html](https://github.com/fattig-riddare-90/journeyman/blob/main/journal/templates/journal/public_entries.html) | Link (if applicable) | ![screenshot](documentation/validation/html-journal-public_entries.png) | Notes (if applicable) |

| users | [create_user.html](https://github.com/fattig-riddare-90/journeyman/blob/main/users/templates/users/create_user.html) | Link (if applicable) | ![screenshot](documentation/validation/html-users-create_user.png) | Notes (if applicable) |

| users | [login.html](https://github.com/fattig-riddare-90/journeyman/blob/main/users/templates/users/login.html) | Link (if applicable) | ![screenshot](documentation/validation/html-users-login.png) | Notes (if applicable) |

| users | [logout.html](https://github.com/fattig-riddare-90/journeyman/blob/main/users/templates/users/logout.html) | Link (if applicable) | ![screenshot](documentation/validation/html-users-logout.png) | Notes (if applicable) |

| users | [start.html](https://github.com/fattig-riddare-90/journeyman/blob/main/users/templates/users/start.html) | Link (if applicable) | ![screenshot](documentation/validation/html-users-start.png) | Notes (if applicable) |
...
- https://jigsaw.w3.org/css-validator/validator?uri=https://journeyman-2025-61e0aac4ec50.herokuapp.com
...
| Directory | File | URL | Screenshot | Notes |
| --- | --- | --- | --- | --- |
| journeyman | [style.css](https://github.com/fattig-riddare-90/journeyman/blob/main/journeyman/static/journeyman/style.css) | Link (if applicable) | ![screenshot](documentation/validation/css-journeyman-style.png) | Notes (if applicable) |
...
| Directory | File | URL | Screenshot | Notes |
| --- | --- | --- | --- | --- |
| journal | [admin.py](https://github.com/fattig-riddare-90/journeyman/blob/main/journal/admin.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/fattig-riddare-90/journeyman/main/journal/admin.py) | ![screenshot](documentation/validation/py-journal-admin.png) | Notes (if applicable) |
| journal | [forms.py](https://github.com/fattig-riddare-90/journeyman/blob/main/journal/forms.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/fattig-riddare-90/journeyman/main/journal/forms.py) | ![screenshot](documentation/validation/py-journal-forms.png) | Notes (if applicable) |
| journal | [models.py](https://github.com/fattig-riddare-90/journeyman/blob/main/journal/models.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/fattig-riddare-90/journeyman/main/journal/models.py) | ![screenshot](documentation/validation/py-journal-models.png) | Notes (if applicable) |
| journal | [tests.py](https://github.com/fattig-riddare-90/journeyman/blob/main/journal/tests.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/fattig-riddare-90/journeyman/main/journal/tests.py) | ![screenshot](documentation/validation/py-journal-tests.png) | Notes (if applicable) |
| journal | [urls.py](https://github.com/fattig-riddare-90/journeyman/blob/main/journal/urls.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/fattig-riddare-90/journeyman/main/journal/urls.py) | ![screenshot](documentation/validation/py-journal-urls.png) | Notes (if applicable) |
| journal | [views.py](https://github.com/fattig-riddare-90/journeyman/blob/main/journal/views.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/fattig-riddare-90/journeyman/main/journal/views.py) | ![screenshot](documentation/validation/py-journal-views.png) | Notes (if applicable) |
| journeyman | [settings.py](https://github.com/fattig-riddare-90/journeyman/blob/main/journeyman/settings.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/fattig-riddare-90/journeyman/main/journeyman/settings.py) | ![screenshot](documentation/validation/py-journeyman-settings.png) | Notes (if applicable) |
| journeyman | [urls.py](https://github.com/fattig-riddare-90/journeyman/blob/main/journeyman/urls.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/fattig-riddare-90/journeyman/main/journeyman/urls.py) | ![screenshot](documentation/validation/py-journeyman-urls.png) | Notes (if applicable) |
|  | [manage.py](https://github.com/fattig-riddare-90/journeyman/blob/main/manage.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/fattig-riddare-90/journeyman/main/manage.py) | ![screenshot](documentation/validation/py--manage.png) | Notes (if applicable) |
| users | [admin.py](https://github.com/fattig-riddare-90/journeyman/blob/main/users/admin.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/fattig-riddare-90/journeyman/main/users/admin.py) | ![screenshot](documentation/validation/py-users-admin.png) | Notes (if applicable) |
| users | [forms.py](https://github.com/fattig-riddare-90/journeyman/blob/main/users/forms.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/fattig-riddare-90/journeyman/main/users/forms.py) | ![screenshot](documentation/validation/py-users-forms.png) | Notes (if applicable) |
| users | [models.py](https://github.com/fattig-riddare-90/journeyman/blob/main/users/models.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/fattig-riddare-90/journeyman/main/users/models.py) | ![screenshot](documentation/validation/py-users-models.png) | Notes (if applicable) |
| users | [tests.py](https://github.com/fattig-riddare-90/journeyman/blob/main/users/tests.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/fattig-riddare-90/journeyman/main/users/tests.py) | ![screenshot](documentation/validation/py-users-tests.png) | Notes (if applicable) |
| users | [urls.py](https://github.com/fattig-riddare-90/journeyman/blob/main/users/urls.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/fattig-riddare-90/journeyman/main/users/urls.py) | ![screenshot](documentation/validation/py-users-urls.png) | Notes (if applicable) |
| users | [views.py](https://github.com/fattig-riddare-90/journeyman/blob/main/users/views.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/fattig-riddare-90/journeyman/main/users/views.py) | ![screenshot](documentation/validation/py-users-views.png) | Notes (if applicable) |
